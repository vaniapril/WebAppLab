...
<table>
    <tr>
        <td>
            <form name="task1" action="preciousmetal" method="post">
                <button type="submit" name="action" value="task1">Maximum percentage year difference</button>
            </form>
        </td>
        <td>
            <form name="task2" action="preciousmetal" method="post">
    ...
    <c:if test="${elements.size() != 0}">
        ...
        <c:forEach var="elem" items="${elements}">
            <tr>
                ...
                <td>
                    <form name="edit" action="preciousmetal" method="post">
                        <input type="hidden" name="action" value="edit"/>
                        <button type="submit" name="uuid" value="${elem.uuid}">Edit</button>
                    </form>
                    <form name="delete" action="preciousmetal" method="post">
...
<form name="new" action="preciousmetal" method="post">
