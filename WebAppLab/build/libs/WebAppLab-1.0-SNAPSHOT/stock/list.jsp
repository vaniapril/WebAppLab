    ...
    <c:if test="${elements.size() != 0}">
        ...
        <c:forEach var="elem" items="${elements}">
            <tr>
                ...
                <td>
                    <form name="edit" action="stock" method="post">
                        <input type="hidden" name="action" value="edit"/>
                        <button type="submit" name="uuid" value="${elem.uuid}">Edit</button>
                    </form>
                    <form name="delete" action="stock" method="post">
...
<form name="new" action="stock" method="post">
